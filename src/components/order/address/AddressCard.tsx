  ...
  return (
    <>
      <div className="p-5 lg:p-3  w-full my-1 bg-white border-2 rounded-xl relative border-slate-100 shadow-sm">
        <input type="radio" name="address" checked={selectedAddress && selectedAddress._id === address._id} onChange={() => setAddress(address)} value={address._id} className="accent-gray-800 absolute top-0 left-0 m-3  w-3 h-3 " />
