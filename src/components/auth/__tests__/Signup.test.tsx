...
describe('<Signup />', () => {
  ...
  it('should render a button to submit the form with text "Continue" with type:submit', () => {
    render(<Signup toggleAuthState={toggleAuthState} />);
    const button = screen.getByRole('button', { name: 'Continue' });
    expect(button).toBeInTheDocument();
    expect(button).toHaveAttribute('type', 'submit');
  });
  it('should render success message on successfull form submission', async () => {
    render(<Signup toggleAuthState={toggleAuthState} />);
    ...
    await waitFor(async () => {
      expect(screen.getByText('An verification link has been sent to your email address')).toBeInTheDocument();
    });
  });
